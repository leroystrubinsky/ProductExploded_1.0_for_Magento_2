...
require([
  ...
  $.widget("pektsekye.productExploded", {
    ...
    _create: function(){   		    
      ...
      this.lastTopPosition = this.defaultLastTopPosition;    
    ...
    addLabel : function(){
     ...
     var positionLeft = this.lastLeftPosition;
     ...
     var nextPositionTop = positionTop + height + 5;     
     if (nextPositionTop > this.options.imageHeight){      
       this.lastLeftPosition = this.lastLeftPosition + this.defaultAreaSize + 5;
       this.lastTopPosition = this.defaultLastTopPosition;      
     } else {      
       this.lastTopPosition = nextPositionTop;
     }
